...
class EntryPlayer:
    ...
    def run(self):
        ...
        for nb_player in range(COUNTER_PLAYER):
            ...
            civility = input("genre du joueur MR/ME: ")
            birth = input("date de naissance du joueur (JJMMAAAA): ")
            classement = input("classement mondial du joueur : ")
            ...
            # transform players into player objects, structure the data
            # entered by the user and save them in a data base
        ...
        # --------enter 8 players arriving of tournament in model----
        # transform in modèle player - iterate to create a player object
        # player = Player()  # creat an object
        # Player.run(list_players)
        ...
        nb_players = len(content_players)
        # number Id created
